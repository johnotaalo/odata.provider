...
/**
 * Repetition pattern for a meeting. InforMEA portal will use one of these predefined constants
 * @see org.informea.odata.IMeeting
 * @author Cristian Romanescu {@code cristian.romanescu _at_ eaudeweb.ro}
 * @version 1.4.0, 10/28/2011
 * @since 0.5
 */
public enum MeetingRepetition {
    ...
    private MeetingRepetition(String name) {
        this.name = name;
    }
