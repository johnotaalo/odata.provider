...
/**
 * Status of the decision. InforMEA portal will use one of these predefined constants
...
public enum DecisionStatus {
    ...
    /**
     * Decision with status "draft"
     */
    DRAFT("draft"),
    /**
     * Decision with status "active"
     */
    ACTIVE("active"),
    /**
     * Decision with status "amended"
     */
    AMENDED("amended"),
    /**
    ...
    private DecisionStatus(String name) {
        this.name = name;
    }
    ...
    public static DecisionStatus fromString(String value) {
        if(value != null) {
            ...
            if(value.equalsIgnoreCase("amended")) {
                return DecisionStatus.AMENDED;
            }
