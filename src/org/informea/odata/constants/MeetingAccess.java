...
/**
 * Public access to the meeting event. InforMEA portal will use one of these predefined constants
...
public enum MeetingAccess {
    ...
    private MeetingAccess(String name) {
        this.name = name;
    }
     ...
     */
    public static MeetingAccess fromString(String value) {
        if(value != null) {
            if(value.equalsIgnoreCase("public")) {
                return MeetingAccess.PUBLIC;
            }
            if(value.equalsIgnoreCase("invitation")) {
                return MeetingAccess.INVITATION;
            }
        }
        return null;
    }
