...
/**
 * Defines the general attributes expected to be exposed by the service for a national plan (action plan)
 * <br />
 * <em>
 ...
 * @since 0.6
 */
public interface INationalPlan extends java.io.Serializable {
     ...
     * portal to negotiate various aspects of data retrieval for a this entity regarding future updates. For example if
     ...
     * <strong>REQUIRED.</strong>
     * Title of the national. You must provide at least the English title of the plan.
