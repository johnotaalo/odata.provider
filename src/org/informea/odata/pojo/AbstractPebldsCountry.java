 ...
 * @since 0.5
 */
public abstract class AbstractPebldsCountry implements Serializable, IAbstractEntity {

    private static final Logger log = Logger.getLogger(AbstractPebldsCountry.class.getName());
    /**
     * Name of the collection as it appears in the OData metadata and response
     */
    public static final String COLLECTION_NAME = "PebldsCountries";
    ...
    public static List<EdmProperty> getPrimitiveProperties() {
        ...
        properties.add(new EdmProperty("id", EdmType.INT16, false));
        properties.add(new EdmProperty("code", EdmType.STRING, false));
        properties.add(new EdmProperty("code2l", EdmType.STRING, false));
    ...
    /**
     * This method works the same as {@link org.informea.odata.pojo.AbstractPebldsCountry#getSchema(String)}, but for a list
     * of entities.
     ...
     */
    public static List<OEntity> asEntities(final EdmEntitySet ees, List<PebldsCountry> entities) {
        return Enumerable.create(entities).select(new Func1<PebldsCountry, OEntity>() {

            @Override
            public OEntity apply(PebldsCountry entityA) {
    ...
    public static EdmEntityType getEntityType(String namespace) {
        return new EdmEntityType(namespace, null, "PebldsCountry", null, Enumerable.create("id").toList(), getPrimitiveProperties(), null);
    }
