...
/**
 * Encapsulates a CountryReport entity used for synchronization handling all the OData specifics. This means that extenders
 * of this class must implement only abstract methods defined by the {@code org.informea.odata.ICountryReport interface} to
 * encode the primitive properties of the primitive properties of a country report object.
...
public abstract class AbstractCountryReport implements ICountryReport, IAbstractEntity {
     ...
     */
    public static final String COLLECTION_NAME = "CountryReports";
    public static final String NAV_PROP_TITLE = "title";

    @Override
    public abstract List<LocalizableString> getTitle();
     ...
     * see {@link org.informea.odata.pojo.AbstractCountryReport#getSchema(String)}.
    ...
    /**
     * This method works the same as {@link org.informea.odata.pojo.AbstractCountryReport#getSchema(String)}, but for a list
     * of entities.
     * @param ees Entity set that describes this object. This was defined in metadata for this object,
     * @param crs List of objects to encode
     * @return List of encoded objects
     */
    public static List<OEntity> asEntities(final EdmEntitySet ees, List<AbstractCountryReport> crs) {
        return Enumerable.create(crs).select(new Func1<AbstractCountryReport, OEntity>() {

            @Override
            public OEntity apply(AbstractCountryReport cr) {
    ...
    public static EdmEntityType getEntityType(String namespace) {
        return new EdmEntityType(namespace, null, "CountryReport", null, Enumerable.create("id").toList(), getPrimitiveProperties(), null);
    }
