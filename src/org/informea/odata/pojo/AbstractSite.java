 ...
 * @since 0.5
 */
public abstract class AbstractSite implements ISite, Serializable, IAbstractEntity {

    private static final long serialVersionUID = -9195501611661862681L;

    private static final Logger log = Logger.getLogger(AbstractSite.class.getName());
    /**
     * Name of the collection as it appears in the OData metadata and response
     */
    public static final String COLLECTION_NAME = "Sites";
    public static final String NAV_PROP_NAME = "name";
     ...
     * see {@link org.informea.odata.pojo.AbstractSite#getSchema(String)}.
    ...
    /**
     * This method works the same as {@link org.informea.odata.pojo.AbstractSite#getSchema(String)}, but for a list
     * of entities.
     * @param ees Entity set that describes this object. This was defined in metadata for this object,
     * @param sites List of objects to encode
     * @return List of encoded objects
     */
    public static List<OEntity> asEntities(final EdmEntitySet ees, List<AbstractSite> sites) {
        return Enumerable.create(sites).select(new Func1<AbstractSite, OEntity>() {

            @Override
            public OEntity apply(AbstractSite site) {
                return site.asEntity(ees);
            }
        }).toList();
    }
    ...
    public static EdmEntityType getEntityType(String namespace) {
        return new EdmEntityType(namespace, null, "Site", null, Enumerable.create("id").toList(), getPrimitiveProperties(), null);
    }
    ...
    public static EdmSchema getSchema(String namespace) {
        ...
        String propertyName = NAV_PROP_NAME;
