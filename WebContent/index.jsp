...
<jsp:include page="WEB-INF/includes/header.jsp">
    ...
    <% } %>
        ...
        <ul class="full">
            <li>
                <a target="_blank" href="http://www.informea.org/api">InforMEA specifications</a> - describes the service and the each of the exposed entities</a>. <em>Always look for the latest version</em>.
            </li>
            <li>
